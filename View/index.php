    		...
    		<div class="row">
    			<div class="col-md-12">
    				<div class="product-slider owl-carousel ftco-animate">
    					<div class="item">
		    				<div class="product">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="View/images/product-1.jpg" alt="Colorlib Template">
	    				...
	    				<div class="item">
		    				<div class="product">
		    					<a href="#" class="img-prod"><img src="View/images/product-5.jpg" alt="Colorlib Template">
			    					<span class="status">30%</span>
			    				</a>
		    					<div class="text pt-3 px-3">
		    						<h3><a href="#">Young Woman Wearing Dress</a></h3>
	    				...
	    				<div class="item">
		    				<div class="product">
		    					<a href="#" class="img-prod"><img src="View/images/product-6.jpg" alt="Colorlib Template"></a>
		    					<div class="text pt-3 px-3">
		    						<h3><a href="#">Young Woman Wearing Dress</a></h3>
		    						<div class="d-flex">
		    							<div class="pricing">
